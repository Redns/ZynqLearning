...
# IP: bd/system/ip/system_flashing_light_0_0/system_flashing_light_0_0.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==system_flashing_light_0_0 || ORIG_REF_NAME==system_flashing_light_0_0} -quiet] -quiet
...
# XDC: e:/Project/ZynqLearning/code/C/2_AXI_FLASHING_LIGHT/2_AXI_FLASHING_LIGHT.gen/sources_1/bd/system/system_ooc.xdc
