...
HD_PWD='E:/Project/ZynqLearning/code/C/2_AXI_FLASHING_LIGHT/2_AXI_FLASHING_LIGHT.runs/system_flashing_light_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_flashing_light_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_flashing_light_0_0.tcl
