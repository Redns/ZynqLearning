...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../2_AXI_FLASHING_LIGHT.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../2_AXI_FLASHING_LIGHT.gen/sources_1/bd/system/ipshared/5765/hdl" \
       +incdir+"../../../../2_AXI_FLASHING_LIGHT.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../2_AXI_FLASHING_LIGHT.gen/sources_1/bd/system/ipshared/5765/hdl" \
