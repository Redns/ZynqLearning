...
namespace eval ::optrace {
  variable script "E:/Project/ZynqLearning/0_GPIO_AXI/0_GPIO_AXI.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/Project/ZynqLearning/0_GPIO_AXI/0_GPIO_AXI.runs/synth_1/system_wrapper.dcp
