...
HD_PWD='E:/Project/ZynqLearning/code/HDL/0_WATERFALL_LIGHT/0_WATERFALL_LIGHT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log waterfall_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source waterfall_light.tcl -notrace
