...
HD_PWD='E:/Project/ZynqLearning/code/HDL/0_WATERFALL_LIGHT/0_WATERFALL_LIGHT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log waterfall_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source waterfall_light.tcl
